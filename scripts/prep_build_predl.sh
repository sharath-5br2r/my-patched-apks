...
mkdir -p ./downloads
# Download Apps
UPDATE_EDEN=$(jq -r '.UPDATE_EDEN // false' .github/scripts/predl_updates.json) || UPDATE_EDEN="false"
UPDATE_WINLATOR=$(jq -r '.UPDATE_WINLATOR // false' .github/scripts/predl_updates.json) || UPDATE_WINLATOR="false"
UPDATE_ZALITH_LAUNCHER=$(jq -r '.UPDATE_ZALITH_LAUNCHER // false' .github/scripts/predl_updates.json) || UPDATE_ZALITH_LAUNCHER="false"
UPDATE_GEODE=$(jq -r '.UPDATE_GEODE // false' .github/scripts/predl_updates.json) || UPDATE_GEODE="false"
UPDATE_LEVILAUNCHER=$(jq -r '.UPDATE_LEVILAUNCHER // false' .github/scripts/predl_updates.json) || UPDATE_LEVILAUNCHER="false"
